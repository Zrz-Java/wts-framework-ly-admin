 ...
 */
package com.wts.framework.wechat.cluster;
...
public class ClusterDataManager {
	...
	public static final String IDSUSER_PREFIX = "IDSUser_";
	...
	public static void put(String __key, Object __value) {
		Cache chCache = createCaChe("ClusterDataManager_Temp_Cache", 3600, 3600);
		net.sf.ehcache.Element element = new net.sf.ehcache.Element(__key, __value);
		chCache.put(element);
	}
