...
public class CMyString {
    ...
    public static String FormatStrFromInput(String fString){
	    if(fString==null){
  		  return "";
  	    }
    ...
    public static String FormatStrFromOutput(String fString){
	    if(fString==null){
  		  return "";
  	    }
    	fString = fString.replaceAll("&amp;", "&");
    ...
    public static String showNull(String _sValue, String _sReplaceIfNull) {
        return (isEmpty(_sValue) ? _sReplaceIfNull : _sValue);
    }
