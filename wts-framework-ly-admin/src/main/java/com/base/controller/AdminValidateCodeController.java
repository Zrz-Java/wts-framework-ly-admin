...
@Controller
public class AdminValidateCodeController {

	public static final String VALIDATE_CODE_KEY = "validateCode";


	@RequestMapping(value = "/admin_validate-code.xhtml", method = RequestMethod.GET)
	public View validateCode(HttpServletRequest request, HttpServletResponse response) {
		...
		request.getSession().setAttribute(VALIDATE_CODE_KEY, sRand);
		g.dispose();
		try {
